...
@nmap_registry.register_transform(display_name="To ping scan (-sP)", input_entity="maltego.CIDR",
                                  description=f'Performs a ping scan. Command: "-sP"',
                                  output_entities=[IPAddress],
                                  transform_set=nmap_set)
class NetblockToPing(DiscoverableTransform):
    CMD = "{target} -sP"
    @classmethod
