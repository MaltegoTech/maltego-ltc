...
from maltego_trx.entities import Phrase, DNS
...
@nmap_registry.register_transform(display_name="To Top Ports (--top-ports -A)", input_entity=DNS,
...
class DNSnameToTopPorts(DiscoverableTransform):
