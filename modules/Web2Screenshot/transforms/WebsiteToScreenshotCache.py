...
@web2screenshot_registry.register_transform(display_name="To Screenshot - Cache [API Flash]",
                                            input_entity="maltego.Website",
                                            description='Take a cache screenshot from an Website, will consume 1 credit'
