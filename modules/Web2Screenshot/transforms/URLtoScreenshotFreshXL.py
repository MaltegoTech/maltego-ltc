...
@web2screenshot_registry.register_transform(display_name="To Screenshot XL - Live [API Flash]",
                                            input_entity="maltego.URL",
                                            description='Take a live full page screenshot from an URL, will consume 1 '
                                                        'credit.',
